var array_concursantes=
			[];
			function agregarElemento() {
				let dato = document.getElementById('texto').value;
				array_concursantes.push(dato)
			}
		    function EliminarElemento() {
				let datoaeliminar = document.getElementById('texto').value;
				queseelimina = array_concursantes.indexOf(datoaeliminar)
				if (queseelimina > -1) {
					array_concursantes.splice(queseelimina, 1)
				} 
			}
